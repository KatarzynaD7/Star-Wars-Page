...
function data()
{
    document.getElementById('data_place').innerHTML="Ładowanie";
            ...
            fetch('https://swapi.co/api/people/'+i+'/').then(function(response)
                {
                ...
                .then(function(jsonData){
                    ...
                    clearInterval(time);
                    document.getElementById('data_place').innerHTML="";
                    document.getElementById('data_place').innerHTML="<div class='nazwisko'>"+jsonData.name+"</div>";
                    document.getElementById('data_place').innerHTML+="rok urodzenia: "+jsonData.birth_year+"</br>";
                    document.getElementById('data_place').innerHTML+="kolor skóry: "+jsonData.skin_color+"</br>";
                    document.getElementById('data_place').innerHTML+="kolor oczu: "+jsonData.eye_color+"</br>";
                    document.getElementById('data_place').innerHTML+="kolor włosów: "+jsonData.hair_color+"</br>";
                    document.getElementById('data_place').innerHTML+="wzrost: "+jsonData.height+"</br>";
                    document.getElementById('data_place').innerHTML+="waga : "+jsonData.mass+"</br>";
                });
            }

data();

document.getElementById('right').addEventListener('click',dataright);
document.getElementById('left').addEventListener('click',dataleft);
